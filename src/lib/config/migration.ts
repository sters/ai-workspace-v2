...
export function generateDefaultConfigContent(): string {
  const lines = [
    ...
    "# operations:",
    "#   maxConcurrent: 3",
    "#   maxGroupConcurrency: 8         # Claude children started at once within one parallel group (per group, so it multiplies with maxConcurrent)",
...
const TYPE_OVERRIDE_HINT_LINES = [
  ...
  "#   # four rungs; override either via steps.<step-type>.{model,effort}:",
  "#   #   opus / high   — needs real thought (open-ended, no checklist):",
  "#   #           analyze-readme, plan-todo, research, coordinate-todos,",
  "#   #           best-of-n-reviewer, autonomous-gate, update-todo",
  "#   #   opus / medium — the default rung:",
  "#   #           execute, code-review, verify-readme, criteria-feasibility,",
  "#   #           validate-pr-comment, ground-finding, resolve-conflicts,",
  "#   #           update-readme, plan-todo-from-review, review-todos,",
  "#   #           suggest-workspace",
  "#   #   opus / low    — a step above mechanical:",
  "#   #           discover-constraints, create-pr, readme-clarity-gate,",
  "#   #           best-of-n-file-reviewer, best-of-n-synthesizer",
  "#   #   sonnet / low  — purely mechanical, nothing to decide:",
  "#   #           prune-suggestions, collect-reviews, verify-todo, deep-search,",
