...
const TYPE_OVERRIDE_HINT_LINES = [
  ...
  "#   #           analyze-readme, plan-todo, research, code-review,",
  "#   #           coordinate-todos, best-of-n-reviewer, autonomous-gate",
  "#   #   opus / medium — the default rung:",
  "#   #           execute, verify-readme, criteria-feasibility, update-readme,",
  "#   #           plan-todo-from-review, review-todos, update-todo,",
  "#   #           suggest-workspace",
