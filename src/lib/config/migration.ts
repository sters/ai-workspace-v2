...
const TYPE_OVERRIDE_HINT_LINES = [
  ...
  "#   #           research, discover-constraints, verify-readme, code-review,",
  "#   #           review-todos, coordinate-todos, update-todo, update-readme,",
  "#   #           best-of-n-reviewer",
  "#   #   sonnet: create-pr, best-of-n-file-reviewer, best-of-n-synthesizer,",
  "#   #           autonomous-gate, readme-clarity-gate, suggest-workspace,",
  ...
  "#   #   high:   analyze-readme, plan-todo, execute, research, verify-readme,",
  "#   #           code-review, coordinate-todos, update-readme,",
  "#   #           best-of-n-reviewer, autonomous-gate",
  "#   #   medium: plan-todo-from-review, discover-constraints, review-todos,",
  "#   #           update-todo, create-pr, best-of-n-file-reviewer,",
  "#   #           best-of-n-synthesizer, readme-clarity-gate, suggest-workspace,",
  "#   #           prune-suggestions",
