...
describe("migrateConfigContent", () => {
  ...
  it("handles fully active config file", () => {
    const content = [
      ...
      "#   #   sonnet: create-pr, best-of-n-reviewer, best-of-n-synthesizer,",
      ...
      "#   #           code-review, coordinate-todos, update-readme, autonomous-gate",
      "#   #   medium: plan-todo-from-review, discover-constraints, review-todos,",
      "#   #           update-todo, create-pr, best-of-n-reviewer,",
